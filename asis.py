...
line = LINE("mhmmdalpi2233@gmail.com","alpiaja12") #Input Your Email and Password Here
#=======================================================================================================================
myMid = line.profile.mid
programStart = time.time()
oepoll = OEPoll(line)
admin = ["u89e83e36dd690ffafa9847f2600dbeb3","uff955e1819b716aec9405a93fe8d58b9","u7e22bb4e1c85ae6d83173bee65281455"]
protectinvite = []
protectkick = []
protectjoin = []
protectqr = []
...
def changevideopp(pict, vids):
    try:
        ...
        obs_params = line.genOBSParams({'oid': admin, 'ver': '2.0', 'type': 'video', 'cat': 'vp.mp4', 'name': 'Hello_World.mp4'})
        data = {'params': obs_params}
        r_vp = line.server.postContent('{}/talk/vp/upload.nhn'.format(str(line.server.LINE_OBS_DOMAIN)), data=data, files=files)
        if r_vp.status_code != 201:
...
def sendFooter(to, isi):
    data = {
        ...
        "sentBy": {
            "label": "  ᴬⁿᵘ™  ",
            #"iconUrl": "https://cdna.artstation.com/p/assets/images/images/016/928/246/original/cloe-ferrara-loader1-0.gif",
...
def mentionMembers(to, mids=[]):
    if admin in mids: mids.remove(myMid)
...
#================BATAS================
       ...
       if msg._from in admin:
        line.sendMessage(to, 'ฉันอยู่ที่นี่เจ้านาย')
    elif cmd == "kickall":
        line.sendMessage(to, 'Sorry, u r not my bouussssss')
    elif cmd == "gas":
       if msg._from in admin:
        line.sendMessage(to, '=====================')
        line.sendMessage(to, '𝐒𝐀𝐋𝐀𝐌 𝐊𝐄𝐍𝐀𝐋 𝐖𝐀𝐑𝐆𝐀 𝐆𝐂 𝐓𝐄𝐑𝐇𝐎𝐑𝐌𝐀𝐓')
        line.sendMessage(to, '𝐌𝐄𝐖𝐃𝐎𝐊 𝐏𝐀𝐎𝐊 𝐇𝐀𝐃𝐈𝐑 𝐍𝐈𝐇')
        line.sendMessage(to, '𝐃𝐀𝐏𝐄𝐓 𝐊𝐀𝐃𝐎 𝐈𝐒𝐈𝐍𝐘𝐀 𝐓𝐎𝐌𝐀𝐓')
        line.sendMessage(to, '𝐋𝐔 𝐌𝐀𝐑𝐀𝐇? 𝐁𝐎𝐃𝐎 𝐀𝐌𝐀𝐓')
        line.sendMessage(to, '𝐍𝐀𝐍𝐆𝐈𝐒 𝐍𝐀𝐍𝐆𝐈𝐒, 𝐌𝐎𝐁𝐈𝐋 𝐊𝐄𝐍𝐀 𝐒𝐄𝐑𝐄𝐌𝐏𝐄𝐓')
        line.sendMessage(to, '𝐌𝐀𝐒 𝐌𝐀𝐍𝐈𝐒, 𝐌𝐀𝐔 𝐃𝐎𝐍𝐆 𝐃𝐈𝐏𝐄𝐏𝐄𝐓')
        line.sendMessage(to, '𝐎𝐑𝐀𝐍𝐆 𝐆𝐀𝐍𝐓𝐄𝐍𝐆 𝐒𝐔𝐊𝐀 𝐒𝐀𝐌𝐀 𝐒𝐈 𝐑𝐈𝐍𝐈')
        line.sendMessage(to, '𝐆𝐀 𝐒𝐔𝐊𝐀, 𝐏𝐂 𝐒𝐈𝐍𝐈')
        line.sendContact(to, 'u89e83e36dd690ffafa9847f2600dbeb3')
        line.sendContact(to, 'u53cbd7c7ee0b30c1c370c5a2524ac5f2')
        line.sendContact(to, 'u32a178ef3094822dc0b02a84d9d418b4')
        line.sendMessage(to, '𝐈𝐊𝐀𝐍 𝐒𝐄𝐏𝐀𝐓 𝐈𝐊𝐀𝐍 𝐆𝐀𝐁𝐔𝐒')
        line.sendMessage(to, '𝐊𝐀𝐋𝐀𝐔 𝐒𝐄𝐌𝐏𝐀𝐓 𝐘𝐀 𝐇𝐀𝐏𝐔𝐒')
        line.sendMessage(to, '🚓𝐆𝐎𝐎𝐃𝐁𝐘𝐄 𝐖𝐀𝐑𝐆𝐀 𝐖𝐔𝐒𝐇𝐇🚓') 
    elif cmd == 'creator':
       if msg._from in admin:
        line.sendContact(to, 'u89e83e36dd690ffafa9847f2600dbeb3')
        line.sendContact(to, 'u89e83e36dd690ffafa9847f2600dbeb3')
...
#================Protection================
       ...
       if msg._from in admin:
                                ...
                                sendFooter(to,"• Protectlist •\n\n- QR Protection :\n"+ma+"\n- Lock Kick :\n"+mb+"\n- Lock Join :\n"+md+"\n- Deny Invitation :\n"+me+"\n- Lock Cancel :\n"+mf+"\nTotal「%s」Protect Group\n\n  𝑀𝑒𝓇𝓇𝓎 𝒥𝓊𝓋𝒾𝓉𝒶  " % (str(len(settings["protectqr"])+len(settings["protectkick"])+len(settings["protectjoin"])+len(settings["protectinvite"])+len(settings["protectcancel"]))))
...
#================Feature================
       ...
       if msg._from in admin:
                                ...
                                sendFooter(to, "  fvck you bangsat ")
def executeOp(op):
    try:
          ...
          if op.param3 in settings["whitelist"]:
                if op.param2 not in settings["whitelist"]:
                    try:
                        ...
                        line.kickoutFromGroup(op.param1,[op.param2])
                        line.cancelGroupInvitation(op.param1,[op.param2])
            	...
            	if msg.toType in (2,1,0):
                    if settings['autokomen']:
                        if msg.contentMetadata['serviceType'] in ['GB', 'NT', 'MH']:
                            ...
                            textt = "anjing yg komen bot semua"
                    ...
                    if settings['autolike']:
                        if msg.contentMetadata['serviceType'] in ['GB', 'NT', 'MH']:
                            if msg.contentMetadata['serviceType'] in ['GB', 'NT']:
                                ...
                                author = msg.contentMetadata['serviceName']
                            posturl = msg.contentMetadata['postEndUrl']
                            sendFooter(to, 'done disLike bos')
                            rep = posturl.replace("line://home/post?userMid=","")
                            sep = rep.split("&postId=")
        ...
        if op.type == 26:
            ...
            receiver = msg.to
            sender   = msg._from
            to       = sender if not msg.toType and sender != admin else receiver
            txt      = text.lower()
            cmd      = command(text)
                ...
                if settings['mimic']['status']:
                    if sender in settings['mimic']['target'] and settings['mimic']['target'][sender]:
                        try:
                            ...
                            pass
                if settings['autoRespondMention']['status']:
                    if msg.toType in [1, 2] and 'MENTION' in msg.contentMetadata.keys() and sender != admin and msg.contentType not in [6, 7, 9]:
                        mentions = ast.literal_eval(msg.contentMetadata['MENTION'])
                        mentionees = [mention['M'] for mention in mentions['MENTIONEES']]
                        if admin in mentionees:
                        ...
                        if Name in cctv['sidermem'][op.param1]:
                            pass
                                ...
                                if " " in Name:
                                    nick = Name.split(' ')
                                    if len(nick) == 2:
                                        line.sendMessageMusic(op.param1, kontak.displayName, 'sɪɴɪ ᴊᴏɪɴ ᴊɢɴ sɪᴅᴇʀ ᴛᴏᴛ', 'line.me/ti/p/~gakpunyaline_', "https://obs.line-apps.com/os/p/{}".format(str(kontak.mid)))
                                        ...
                                        line.sendMessageMusic(op.param1, kontak.displayName, 'ʟᴀɢɪ ɴɢ*ᴡᴇ ʏᴀ? ᴍᴀᴋᴀɴɴʏᴀ sɪᴅᴇʀ', 'line.me/ti/p/~gakpunyaline_', "https://obs.line-apps.com/os/p/{}".format(str(kontak.mid)))
                                        #sendMention(op.param1, "Kak @! sider mulu, jomblo ya ka?",[op.param2])
                                        #line.sendImageWithURL(op.param1, "http://dl.profile.line-cdn.net" + line.getContact(op.param2).picturePath)
                                else:
                                    line.sendMessageMusic(op.param1, kontak.displayName, 'ᴊᴀɴɢᴀɴ sɪᴅᴇʀ ʏᴀ ʙᴀɴɢsᴀᴛ ', 'line.me/ti/p/~gakpunyaline_', "https://obs.line-apps.com/os/p/{}".format(str(kontak.mid)))
